...
if __name__ == "__main__":
    ...
    if tumour:
        dataset = BrainWebClean(path_to_files="path_to/clean/clean_train_tumour.pt")
    else:
        dataset = BrainWebClean(path_to_files="path_to/clean/clean_train.pt")
    ...
    for trues_per_volume in trues_per_volumes:
        ...
        if tumour:
            torch.save(save_dict, f"path_to/noisy/noisy_train_tumour_{trues_per_volume}.pt")
        else:
            torch.save(save_dict, f"path_to/noisy/noisy_train_{trues_per_volume}.pt")
